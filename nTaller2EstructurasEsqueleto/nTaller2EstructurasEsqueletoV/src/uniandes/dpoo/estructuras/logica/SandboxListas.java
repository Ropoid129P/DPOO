...
public class SandboxListas
{
    ...
    public void eliminarEntero( int valor )
    {
        ...
        while( it.hasNext( ) )
        {
            ...
            if( actual != null && actual.intValue( ) == valor )
            {
                it.remove( );
            }
        }
    ...
    public int contarApariciones( String cadena )
    {
        ...
        for( String s : listaCadenas )
        {
            ...
            else if( s != null && s.equalsIgnoreCase( cadena ) )
            {
                conteo++;
            }
        }
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        int repetidosDistintos = 0;
        int i = 0;
        while( i < copia.size( ) )
        {
            Integer actual = copia.get( i );
            int j = i + 1;
            while( j < copia.size( ) )
            {
                Integer siguiente = copia.get( j );
                if( actual == null ? siguiente == null : actual.equals( siguiente ) )
                    j++;
                else
                    break;
            }
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
        ...
        {
            int valor = min + ( int )Math.floor( Math.random( ) * rango );
